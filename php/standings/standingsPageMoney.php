    ...
    <div style="overflow: auto;">
        <table>
            ...
            <?PHP
                ...
                {
                    $transfers = json_decode(file_get_contents("https://fantasy.premierleague.com/api/entry/".$moneyS['entry']."/event/".$leagues['current_event']."/picks/"), true);
            ?>
                <tr style="text-align:center;">
                    <td>
                        <?PHP echo $moneyS['rank'];
                        if($moneyS['rank'] < $moneyS['last_rank']) {
                        ...
                        } elseif($moneyS['rank'] > $moneyS['last_rank'] && $moneyS['last_rank'] != 0) {
                    ...
                    <td class="nameCol" style="text-transform:capitalize;">
                        <?PHP
                        echo '<span class="name" style="font-weight:bold;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:inline-block;vertical-align:bottom;">'.$moneyS['player_name'].'</span>';
                    ...
                    <td><?PHP echo $moneyS['total']; ?></td>
                    <td>
                        <?PHP
                        $difference = $moneyStandings['standings']['results'][0]['total'] - $moneyS['total'];
                        if($difference === 0) {
                            echo "-";
                        } else {
                            echo $difference;
            ...
            ?>
                <tr style="text-align:center;">
                    ...
                    <td class="nameCol" style="text-transform:capitalize;">
                        <?PHP
                        echo $moneySnew['player_first_name'].' '.$moneySnew['player_last_name'];
                        ?>
                    </td>
                    <td>-</td>
                    <td>-</td>
