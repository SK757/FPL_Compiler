...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/css/main.css?0.5">
    ...
    <link rel="manifest" href="/favicon/site.webmanifest?v=0.4">
...
<body>
    ...
    <main style="display: none;">
        <?php
            $data = json_decode(file_get_contents("https://fantasy.premierleague.com/api/entry/581004/history/"), true);
        ?>
