...
function notAvailable() {
	$("tr:contains('Loan'), tr:contains('loan'), tr:contains('Joined'), tr:contains('Contract'), tr:contains('Transferred'), tr:contains('Not included in'), tr:contains('Left the club')").addClass("filterPosition");
}
