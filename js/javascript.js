...
function notAvailable() {
	$("tr:contains('Loan'), tr:contains('loan'), tr:contains('Joined'), tr:contains('Contract'), tr:contains('Transferred'), tr:contains('Not included in'), tr:contains('Left'), tr:contains('Retired'), tr:contains('Recalled'), tr:contains('Permanent'), tr:contains('permanent'), tr:contains('Released'), tr:contains('Season long')").addClass("filterPosition");
}
