...
for gw in range(1, lastGameweek + 1):
    ...
    for player in range(0, 11): # starting line-up
...
ax3.set_xticklabels(gameweek, rotation=45, ha="right", size=8)
...
colors = ['#f1d18a', '#54c78f', '#a174c4', '#73b1c1']
...
fig.savefig('2024-25/gw30-38/gw38.png')
